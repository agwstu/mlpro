...
```zsh
Rscript src/models/classification.R
```
...
```zsh
Rscript -e 'rmarkdown::render("notebooks/classification.Rmd")'; osascript -e 'display notification "rmarkdown is knitted" with title "Done"'
```

[filestructure]: classification/FILESTRUCTURE.md
...
Your name (or your organization/company/team) Your email
