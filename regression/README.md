...
```zsh
Rscript src/models/regression.R
```
...
```zsh
Rscript -e 'rmarkdown::render("notebooks/regression.Rmd")'; osascript -e 'display notification "rmarkdown is knitted" with title "Done"'
```

[filestructure]: regression/FILESTRUCTURE.md
