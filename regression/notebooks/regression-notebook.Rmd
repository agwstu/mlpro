...
t_test_test_across_centuries(timbre_covariance_data_with_target,
                             'V15')
```
We have shown that across the centuries averages differ for the variables that are the most correlated with the target variable. It might be an indicator that these variables will play a significant role in predicting the song release year.
